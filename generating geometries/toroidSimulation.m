...
start_stage2 = 5e3; % Iteration when we close the holes
stop_forcing_tubelets = inf; % Iteration when we stop maintaining the tubes
stop_pushing_junctions = 6e3; % Iteration when we stop pushing out the junctions to keep them from buckling
...
angle_check_frequency = 100; % How often should we calculate the preferred angles
